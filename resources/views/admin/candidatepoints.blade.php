...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3 text-center">Add Points For Candidate</h1>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3 d-grid">
                                <td><button type="button" class="btn btn-dark btn-sm add_item_btn" id="positive_btn">+</button></td>
                            ...
                            <div class="form-group">
                                <label for="">Negitive Points</label>
                                <div id="show_item1">
                        <div class="row">
                            <div class="col-md-10 mb-3">
                            ...
                            <div class="col-md-2 mb-3 d-grid">
                                <button type="button" class="btn btn-dark btn-sm add_item_btn1" id="negitive_btn">+</button>
                            </div>
